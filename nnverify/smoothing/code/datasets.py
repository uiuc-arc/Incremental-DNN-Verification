...
def _cifar10(split: str) -> Dataset:
    if split == "train":
        return datasets.CIFAR10("./data", train=True, download=True, transform=transforms.Compose([
            transforms.RandomCrop(32, padding=4),
            transforms.RandomHorizontalFlip(),
            transforms.ToTensor()
        ]))
    elif split == "test":
        return datasets.CIFAR10("./data", train=False, download=True, transform=transforms.ToTensor())
...
def _imagenet(split: str) -> Dataset:
    ...
    if split == "train":
        ...
        datasets.ImageNet(train=True, root=dir, download=True)
